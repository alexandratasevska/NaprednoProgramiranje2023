...
int main() {
    ...
    Rectangle rectangle;
    Triangle triangle;
    // mojot indeks e 1002, ke iskoristam dimenzi za rectangle(82,2) i triangle(8, 22) 
    rectangle.setDimensions(82, 2);
    triangle.setDimensions(8, 22);
